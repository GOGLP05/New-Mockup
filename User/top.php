...
<body>
    ...
    <div class="content">
        <h1>作れる料理</h1>
        <div class="grid">
            <div class="grid-item"><a href="recipe_detail.html">肉じゃが</a></div>
            <div class="grid-item"><a href="recipe_detail.html">ハンバーグ</a></div>
            <div class="grid-item"><a href="recipe_detail.html">ミートスパゲッティ</a></div>
            <div class="grid-item"><a href="recipe_detail.html">ジャガイモグラタン</a></div>
            <div class="grid-item"><a href="recipe_detail.html">大学芋</a></div>
            <div class="grid-item"><a href="recipe_detail.html">煮物</a></div>
        </div>
